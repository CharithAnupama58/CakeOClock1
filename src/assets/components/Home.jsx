    ...
    return (
        <section className="relative">
            ...
            <div className="absolute top-96 left-1/3 transform -translate-x-1/2 -translate-y-1/2 text-center text-white font-semibold">
                ...
                <button className='mt-16 border border-solid border-white-800 border-4 px-4 py-2 rounded-xl text-white-700 hover:bg-slate-500 font-semibold'>
                    Order Online
                </button>
            </div>
            ...
            <div className='flex w-full h-96 bg-black'>
                ...
                <div className='flex-col justify-end mr-96 mt-5'>
                    <form className='text-start -mr-44'>
                        <h2 className='text-2xl font-semibold text-white'>Name</h2>
                        <input className='w-96 mt-2 ml-0 rounded-xl' type='text' placeholder='Enter Your Name' />

                        <h2 className='text-2xl font-semibold mt-4 text-white'>Email</h2>
                        <input className='w-96 mt-2 ml-0 rounded-xl' type='text' placeholder='Enter Your Email' />

                        <h2 className='text-2xl font-semibold mt-4 text-white'>Message</h2>
                        <textarea rows='2' cols='30' className='w-96 mt-2 ml-0 rounded-xl' type='text' placeholder='Enter Your Message..' />
                    </form>

                    <button className='mt-4 border border-solid border-white-800 border-4 px-4 py-2 rounded-xl text-white hover:bg-slate-500 font-semibold'>
                        Submit
                    </button>
                </div>
